...
> **消费点**：扫榜调研域按需加载——查题材趋势候选、切入约束与样本校验规则时
> **边界**：管题材趋势与流派要点；读者画像归 references/scan/scan-reader-profiling.md，平台调性见 references/scan/scan-workflow.md 速查表
...
**起点**：三江→首订图→签约新书榜前15→重点研究精品到万订之间的书
...
- 历史/年代文：宋朝以后审核风险高（对照流派写作要点历史文行）
- 同人文：仅限用户明确目标 IP 且平台允许、近期样本有效时使用
- 通用红线：涉政、涉黑、过度血腥、擦边为全平台通用风险；题材级具体约束随实测补充〔abzu 自定散注汇总〕
